...
Could do with being tidied up and refatored
'''
...
amip_dict = {
             ...
             'BCC-CSM2-MR' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/BCC/BCC-CSM2-MR/amip/r1i1p1f1/Amon/wap/gn/latest/wap_Amon_BCC-CSM2-MR_amip_r1i1p1f1_gn_197901-201412.nc', 
             'BCC-ESM1' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/BCC/BCC-ESM1/amip/r1i1p1f1/Amon/wap/gn/latest/wap_Amon_BCC-ESM1_amip_r1i1p1f1_gn_197901-201412.nc', 
             'CAMS-CSM1-0' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/CAMS/CAMS-CSM1-0/amip/r1i1p1f1/Amon/wap/gn/latest/wap_Amon_CAMS-CSM1-0_amip_r1i1p1f1_gn_197901-201412.nc', 
             'CanESM5' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/CCCma/CanESM5/amip/r1i1p2f1/Amon/wap/gn/latest/wap*.nc', 
             'FGOALS-f3-L' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/CAS/FGOALS-f3-L/amip/r1i1p1f1/Amon/wap/gr/latest/wap_Amon_FGOALS-f3-L_amip_r1i1p1f1_gr_197901-201412.nc',
             ...
             'MIROC6' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/MIROC/MIROC6/amip/r1i1p1f1/Amon/wap/gn/latest/*.nc', 
...
amip_p4k_dict = {
                 'BCC-CSM2-MR' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CFMIP/BCC/BCC-CSM2-MR/amip-p4K/r1i1p1f1/Amon/wap/gn/latest/wap*.nc', 
                 'CESM2': '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CFMIP/NCAR/CESM2/amip-p4K/r1i1p1f1/Amon/wap/gn/latest/*.nc', 
                 'CNRM-CM6-1' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CFMIP/CNRM-CERFACS/CNRM-CM6-1/amip-p4K/r1i1p1f2/Amon/wap/gr/latest/wap*.nc',
                 'CanESM5' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CFMIP/CCCma/CanESM5/amip-p4K/r1i1p2f1/Amon/wap/gn/latest/wap*.nc', 
                 'E3SM-1-0' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CFMIP/E3SM-Project/E3SM-1-0/amip-p4K/r2i1p1f1/Amon/wap/gr/latest/*.nc',
                 'GFDL-CM4' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CFMIP/NOAA-GFDL/GFDL-CM4/amip-p4K/r1i1p1f1/Amon/wap/gr1/latest/wap_Amon_GFDL-CM4_amip-p4K_r1i1p1f1_gr1_197901-201412.nc', 
                 'GISS-E2-1-G' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CFMIP/NASA-GISS/GISS-E2-1-G/amip-p4K/r1i1p1f1/Amon/wap/gn/latest/wap*.nc',
                 ...
                 'MIROC6' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CFMIP/MIROC/MIROC6/amip-p4K/r1i1p1f1/Amon/wap/gn/latest/wap*.nc', 
                 ...
                 'TaiESM1' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CFMIP/AS-RCEC/TaiESM1/amip-p4K/r1i1p1f1/Amon/wap/gn/latest/wap*.nc' 
                }
picontrol_dict = {
                  'HadGEM3-GC31-LL' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/MOHC/HadGEM3-GC31-LL/piControl/r1i1p1f1/Emon/wap/gn/latest/wap_Emon_HadGEM3-GC31-LL_piControl_r1i1p1f1_gn*.nc', 
#                  'HadGEM3-GC31-MM' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/MOHC/HadGEM3-GC31-MM/piControl/r1i1p1f1/Emon/wap/gn/latest/*.nc', # wap is available on model levels, but pressure on levels is not, so can't get 500 hPa vertical velocity
                  'BCC-CSM2-MR' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/BCC/BCC-CSM2-MR/piControl/r1i1p1f1/Amon/wap/gn/latest/wap_Amon_BCC-CSM2-MR_piControl_r1i1p1f1_gn_*.nc', 
                  'BCC-ESM1' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/BCC/BCC-ESM1/piControl/r1i1p1f1/Amon/wap/gn/latest/wap_Amon_BCC-ESM1_piControl_r1i1p1f1_gn*.nc',
                  'CAMS-CSM1-0' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/CAMS/CAMS-CSM1-0/piControl/r1i1p1f1/Amon/wap/gn/latest/wap_Amon_CAMS-CSM1-0_piControl_r1i1p1f1_gn*.nc',
                  'CanESM5' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/CCCma/CanESM5/piControl/r1i1p2f1/Amon/wap/gn/latest/wap*.nc', 
                  'FGOALS-f3-L' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/CAS/FGOALS-f3-L/piControl/r1i1p1f1/Amon/wap/gr/latest/wap_Amon_FGOALS-f3-L_piControl_r1i1p1*.nc', 
                  ...
                  'MIROC6' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/MIROC/MIROC6/piControl/r1i1p1f1/Amon/wap/gn/latest/wap_Amon_MIROC6_piControl_r1i1p1f1_gn*.nc', 
                  ...
                  'SAM0-UNICON' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/SNU/SAM0-UNICON/piControl/r1i1p1f1/Amon/wap/gn/latest/wap_Amon_SAM0-UNICON_piControl_r1i1p1f1_gn*.nc' 
                 }
abrupt4co2_dict = {
                   ...
                   'BCC-CSM2-MR' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/BCC/BCC-CSM2-MR/abrupt-4xCO2/r1i1p1f1/Amon/wap/gn/latest/wap_Amon_BCC-CSM2-MR_abrupt-4xCO2_r1i1p1f1_gn_*.nc',
                   'BCC-ESM1' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/BCC/BCC-ESM1/abrupt-4xCO2/r1i1p1f1/Amon/wap/gn/latest/wap_Amon_BCC-ESM1_abrupt-4xCO2_r1i1p1f1*.nc',
                   'CanESM5' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/CCCma/CanESM5/abrupt-4xCO2/r1i1p2f1/Amon/wap/gn/latest/wap*.nc', 
                   'CAMS-CSM1-0' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/CAMS/CAMS-CSM1-0/abrupt-4xCO2/r1i1p1f1/Amon/wap/gn/latest/wap_Amon_CAMS-CSM1-0_abrupt-4xCO2_r1i1p1f1_gn*.nc', 
                   ...
                   'MIROC6' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/MIROC/MIROC6/abrupt-4xCO2/r1i1p1f1/Amon/wap/gn/latest/wap_Amon_MIROC6_abrupt-4xCO2_r1i1p1f1_gn*.nc', 
                   ...
                   'GFDL-CM4' : '/gws/nopw/j04/circulates_vol2/PHill/CMIP6/CMIP/NOAA-GFDL/GFDL-CM4/abrupt-4xCO2/r1i1p1f1/Amon/wap/gr1/latest/wap_Amon_GFDL-CM4_abrupt-4xCO2_r1i1p1f1_gr*.nc', 
...
def combine_reanalyses(era5_data, merra2_data, jra55_data, w500_bins_mid):
    tot_data = {}
    ...
    tot_data.update({'Circ Intensity' : (tot_data['w500_hist']*w500_bins_mid)[w500_bins_mid > 0.].sum()/tot_data['w500_hist'][w500_bins_mid > 0].sum()-(tot_data['w500_hist']*w500_bins_mid)[w500_bins_mid < 0.].sum()/tot_data['w500_hist'][w500_bins_mid < 0].sum()})
    tot_data.update({'Circ mav' : np.sum(tot_data['w500_hist']*abs(w500_bins_mid))/np.sum(tot_data['w500_hist'])})
    tot_data.update({'Circ Mode' : w500_bins_mid[np.argmax(tot_data['w500_hist'])]})
    era5_data.update({'Circ Intensity' : (era5_data['w500_hist']*w500_bins_mid)[w500_bins_mid > 0.].sum()/era5_data['w500_hist'][w500_bins_mid > 0].sum()-(era5_data['w500_hist']*w500_bins_mid)[w500_bins_mid < 0.].sum()/era5_data['w500_hist'][w500_bins_mid < 0].sum()})
    era5_data.update({'Circ mav' : np.sum(era5_data['w500_hist']*abs(w500_bins_mid))/np.sum(era5_data['w500_hist'])})
    era5_data.update({'Circ Mode' : w500_bins_mid[np.argmax(era5_data['w500_hist'])]})
    jra55_data.update({'Circ Intensity' : (jra55_data['w500_hist']*w500_bins_mid)[w500_bins_mid > 0.].sum()/jra55_data['w500_hist'][w500_bins_mid > 0].sum()-(jra55_data['w500_hist']*w500_bins_mid)[w500_bins_mid < 0.].sum()/jra55_data['w500_hist'][w500_bins_mid < 0].sum()})
    jra55_data.update({'Circ mav' : np.sum(jra55_data['w500_hist']*abs(w500_bins_mid))/np.sum(jra55_data['w500_hist'])})
    jra55_data.update({'Circ Mode' : w500_bins_mid[np.argmax(jra55_data['w500_hist'])]})
    merra2_data.update({'Circ Intensity' : (merra2_data['w500_hist']*w500_bins_mid)[w500_bins_mid > 0.].sum()/merra2_data['w500_hist'][w500_bins_mid > 0].sum()-(merra2_data['w500_hist']*w500_bins_mid)[w500_bins_mid < 0.].sum()/merra2_data['w500_hist'][w500_bins_mid < 0].sum()})
    merra2_data.update({'Circ mav' : np.sum(merra2_data['w500_hist']*abs(w500_bins_mid))/np.sum(merra2_data['w500_hist'])})
    merra2_data.update({'Circ Mode' : w500_bins_mid[np.argmax(merra2_data['w500_hist'])]})
    return tot_data, era5_data, merra2_data, jra55_data
...
def get_cmip6_param_data(spatial_av_scale=2.0, w500_bins=np.arange(-700,700.01,2), cre_bins=np.arange(-400,400.01,0.2), lon_min=165, lon_max=235, lat_min=-30, lat_max=30, experiment='AMIP', n_bootstrap=2, seed=1, time_av_scale=720, yearlist=range(2001,2015), fit_param=True):
    ...
    for k in w500_hist.keys():
        print('k=', k)
        amip_data.update({k : {}})
        amip_data[k].update({'circ_intensity' : (w500_hist[k]*w500_bins_mid)[w500_bins_mid > 0.].sum()/w500_hist[k][w500_bins_mid > 0].sum()-(w500_hist[k]*w500_bins_mid)[w500_bins_mid < 0.].sum()/w500_hist[k][w500_bins_mid < 0].sum()})
        amip_data[k].update({'circ_mav' : np.sum(w500_hist[k]*abs(w500_bins_mid))/np.sum(w500_hist[k])})
        amip_data[k].update({'w500_hist' : w500_hist[k]})
        amip_data[k].update({'circ_intensity_bootstrap'  : []})
        amip_data[k].update({'circ_mav_bootstrap'  : []})
        amip_data[k].update({'circ_mode' : w500_bins_mid[w500_hist[k].argmax()]})
        amip_data[k].update({'circ_mode_bootstrap'  : []})
        for jj in range(n_bootstrap):
            seed = seed + jj
            rng = Generator(PCG64(seed))
            samples = rng.choice(w500_bins_mid, n_samples, p=w500_hist[k]/w500_hist[k].sum())            
            amip_data[k]['circ_intensity_bootstrap'] += [np.mean(samples[samples >= 0.])-np.mean(samples[samples < 0.])]
            amip_data[k]['circ_mav_bootstrap'] += [np.mean(abs(samples))]
            amip_data[k]['circ_mode_bootstrap'] += [stats_mode(samples)[0][0]]
        amip_data[k].update({'sw_cre_mean' : sw_cre_sum[k] / w500_hist[k]})
        amip_data[k].update({'lw_cre_mean' : lw_cre_sum[k] / w500_hist[k]})
        amip_data[k].update({'sw_cre_hist' : w500_sw_cre_hist[k]})
        amip_data[k].update({'lw_cre_hist' : w500_lw_cre_hist[k]})
    return amip_data


def calc_feedbacks(w500_bins=np.arange(-700,700.01,2), cre_bins=np.arange(-400,400.01,0.2), yearlist=range(2001,2015), n_bootstrap=2, lon_min=165, lon_max=235, lat_min=-30, lat_max=30, seed=1, spatial_av_scale=2.0, time_av_scale=24*30, rad_source='CERES_EBAF'):
    '''
    ...
    w500_bins_mid = 0.5*(w500_bins[1:]+w500_bins[:-1])
    complete_model_list = []
    quad_co2_forcing, all_sky_feedback, net_cre_dynamic, net_cre_thermodynamic, net_cre_co_variation,sw_cre_dynamic, sw_cre_thermodynamic, sw_cre_co_variation, lw_cre_dynamic, lw_cre_thermodynamic, lw_cre_co_variation, net_cre_dynamic_obs, net_cre_thermodynamic_obs, net_cre_co_variation_obs,sw_cre_dynamic_obs, sw_cre_thermodynamic_obs, sw_cre_co_variation_obs, lw_cre_dynamic_obs, lw_cre_thermodynamic_obs, lw_cre_co_variation_obs, net_cre_dynamic_feedback, net_cre_thermodynamic_feedback, net_cre_co_variation_feedback,sw_cre_dynamic_feedback, sw_cre_thermodynamic_feedback, sw_cre_co_variation_feedback, lw_cre_dynamic_feedback, lw_cre_thermodynamic_feedback, lw_cre_co_variation_feedback, net_cre_dynamic_obs_feedback, net_cre_thermodynamic_obs_feedback, net_cre_co_variation_obs_feedback,sw_cre_dynamic_obs_feedback, sw_cre_thermodynamic_obs_feedback, sw_cre_co_variation_obs_feedback, lw_cre_dynamic_obs_feedback, lw_cre_thermodynamic_obs_feedback, lw_cre_co_variation_obs_feedback = ({} for __ in range(38))
#   Get observed data
    ...
    obs_data = {}
    obs_data_ann, era5_data_ann, merra2_data_ann, jra55_data_ann = combine_reanalyses(era5_vs_ceres_two_deg_monthly['Ann'], merra2_vs_ceres_two_deg_monthly['Ann'], jra55_vs_ceres_two_deg_monthly['Ann'], w500_bins_mid)
...
#   Get fits, which we use to compare whether they change with time period and model version and whether the fit is good enough to use instead of data
    n_samples = int(((lat_max-lat_min)/spatial_av_scale)*((lon_max-lon_min)/spatial_av_scale)*(len(yearlist)*12*30*24/time_av_scale))
    obs_data['Ann'] = bootstrap_sample_obs_intensity(obs_data['Ann'], w500_bins_mid, [obs_data, era5_vs_ceres_two_deg_monthly, merra2_vs_ceres_two_deg_monthly, jra55_vs_ceres_two_deg_monthly], n_samples, n_bootstrap=n_bootstrap, seed=seed)
...
#   First compare data across scenarios and averaging period.
    plot_scenario_comparison(complete_model_list, [AMIP_params_ceres_era, AMIP_params_long, PiControl_params, abrupt4CO2_params], obs_data['Ann'], var='circ_intensity', lon_min=lon_min, lon_max=lon_max, lat_min=lat_min, lat_max=lat_max)
    plot_scenario_comparison(complete_model_list, [AMIP_params_ceres_era, AMIP_params_long, PiControl_params, abrupt4CO2_params], obs_data['Ann'], var='circ_mode', ylabel='Modal vertical velocity (hPa day$^{-1}$)', lon_min=lon_min, lon_max=lon_max, lat_min=lat_min, lat_max=lat_max)
...
#       Plot vs observations
        ...
        plt.savefig('/home/users/phill/images/CIRCULATES/dynamic_cloud_feedbacks/w500_dist_'+model+'vs_obs'+'_lon'+str(lon_min)+'to'+str(lon_max)+'_lat'+str(lat_min)+'to'+str(lat_max)+'_'+plot_type)
        plt.clf()
...
#   This requires CO2 forcing, which we get using Gregory method 
    for model in complete_model_list:
        ...
        for rad in [net_cre_dynamic, net_cre_thermodynamic, net_cre_co_variation,sw_cre_dynamic, sw_cre_thermodynamic, sw_cre_co_variation, lw_cre_dynamic, lw_cre_thermodynamic, lw_cre_co_variation, net_cre_dynamic_obs, net_cre_thermodynamic_obs, net_cre_co_variation_obs, sw_cre_dynamic_obs, sw_cre_thermodynamic_obs, sw_cre_co_variation_obs, lw_cre_dynamic_obs, lw_cre_thermodynamic_obs, lw_cre_co_variation_obs]:
            rad.update({model : []})
...
def obs_interannual_var(w500_bins=np.arange(-700,700.01,2), cre_bins=np.arange(-400,400.01,0.2), yearlist=range(2001,2015), n_bootstrap=2, lon_min=165, lon_max=235, lat_min=-30, lat_max=30, seed=1, spatial_av_scale=2.0, time_av_scale=24*30, rad_source='CERES_EBAF', w500_source='ERA5'):
    ...
    plt.ylim([-45,-25])
    fig.tight_layout()
    plt.savefig('/home/users/phill/images/CIRCULATES/dynamic_cloud_feedbacks/'+w500_source+'zoomed_sw_cre_vs_w500_by_year'+plot_type)
    plt.show()
    return obs_data
...
#   SW CRE vs w500
    ...
    for ii in range(2): # 2 panels, 7 models per panel
        ...
        if ii == 0:
            ...
            ax.tick_params(labelleft=False)
    fig.subplots_adjust(left=0.105, right=0.95, bottom=0.1, top=0.95, wspace=0.16, hspace=0.11)
    plt.savefig('/home/users/phill/images/CIRCULATES/dynamic_cloud_feedbacks/sw_cre_vs_w500_models_vs_obs_diff'+'_lon'+str(lon_min)+'to'+str(lon_max)+'_lat'+str(lat_min)+'to'+str(lat_max)+'_w500bin_width'+'{:.2f}'.format(w500_bins[1]-w500_bins[0]).replace('.', 'pt')+'_w500bin_max'+'{:.2f}'.format(w500_bins[-1]).replace('.', 'pt')+'_crebin_width'+'{:.2f}'.format(cre_bins[1]-cre_bins[0]).replace('.', 'pt')+'_crebin_max'+'{:.2f}'.format(cre_bins[-1]).replace('.', 'pt')+plot_type)
    plt.show()
#   LW CRE vs w500
    if plot_type == '.png':
        fig = plt.figure(0, figsize=(7,3))
    ...
    for ii in range(2): # 2 panels, 7 models per panel
        ...
        if ii == 0:
            ...
            ax.tick_params(labelleft=False)
    fig.subplots_adjust(left=0.105, right=0.95, bottom=0.1, top=0.95, wspace=0.16, hspace=0.11)
    plt.savefig('/home/users/phill/images/CIRCULATES/dynamic_cloud_feedbacks/lw_cre_vs_w500_models_vs_obs_diff'+'_lon'+str(lon_min)+'to'+str(lon_max)+'_lat'+str(lat_min)+'to'+str(lat_max)+'_w500bin_width'+'{:.2f}'.format(w500_bins[1]-w500_bins[0]).replace('.', 'pt')+'_w500bin_max'+'{:.2f}'.format(w500_bins[-1]).replace('.', 'pt')+'_crebin_width'+'{:.2f}'.format(cre_bins[1]-cre_bins[0]).replace('.', 'pt')+'_crebin_max'+'{:.2f}'.format(cre_bins[-1]).replace('.', 'pt')+plot_type)
    plt.show()
#   w500 distribution
    if plot_type == '.png':
        fig = plt.figure(0, figsize=(7,3))
    ...
    for ii in range(2,4): # 2 panels, 7 models per panel
        ...
        if ii == 2:
            ...
            ax.tick_params(labelleft=False)
    fig.tight_layout()
    plt.savefig('/home/users/phill/images/CIRCULATES/dynamic_cloud_feedbacks/w500_dist_models_vs_obs_diff'+'_lon'+str(lon_min)+'to'+str(lon_max)+'_lat'+str(lat_min)+'to'+str(lat_max)+'_w500bin_width'+'{:.2f}'.format(w500_bins[1]-w500_bins[0]).replace('.', 'pt')+'_w500bin_max'+'{:.2f}'.format(w500_bins[-1]).replace('.', 'pt')+'_crebin_width'+'{:.2f}'.format(cre_bins[1]-cre_bins[0]).replace('.', 'pt')+'_crebin_max'+'{:.2f}'.format(cre_bins[-1]).replace('.', 'pt')+plot_type)
    plt.show()
#   Plot one reanalysis and one model with error bars showing sampling uncertainty on the cre dependence on w500.
    ...
    plt.xlabel('Circulation Regime ($\omega$500, hPa day$^{-1}$)')
    plt.ylabel('Mean SW CRE (W m$^{-2}$)')
    plt.savefig('/home/users/phill/images/CIRCULATES/dynamic_cloud_feedbacks/sw_cre_vs_w500_plus_sampling_error_ERA5_IPSL.png')
    plt.show()
...
#   Plot individual models as differences, 
    ...
    for ii in range(2): # 2 panels, 7 models per panel
        ...
        plt.ylabel('CMIP6 - observed frequency')
    fig.tight_layout()
    plt.savefig('/home/users/phill/images/CIRCULATES/dynamic_cloud_feedbacks/w500_dist_models_vs_obs_diff'+'_lon'+str(lon_min)+'to'+str(lon_max)+'_lat'+str(lat_min)+'to'+str(lat_max)+'_w500bin_width'+'{:.2f}'.format(w500_bins[1]-w500_bins[0]).replace('.', 'pt')+'_w500bin_max'+'{:.2f}'.format(w500_bins[-1]).replace('.', 'pt')+'_crebin_width'+'{:.2f}'.format(cre_bins[1]-cre_bins[0]).replace('.', 'pt')+'_crebin_max'+'{:.2f}'.format(cre_bins[-1]).replace('.', 'pt')+'_v2'+plot_type)
    plt.show()
...
#   SW CRE by model
    ...
    for ii in range(13):
        ...
        plot_circ_cloud_relationships(w500_bins, cre_bins, obs_data, AMIP_params_ceres_4K[model], AMIP_params_long_4K[model], labels=['Obs','AMIP 2001-2014', 'AMIP 1979-2014', ''], list_of_colors=[colorlist[3], colorlist[0], colorlist[1], colorlist[2]], era5_data=era5_data, jra55_data=jra55_data, merra2_data=merra2_data, var='sw_cre_adj2_mean', fig=fig, subplot_index=(5,3,ii+1), lon_min=lon_min, lon_max=lon_max, lat_min=lat_min, lat_max=lat_max, savename='/home/users/phill/images/CIRCULATES/dynamic_cloud_feedbacks/w500_vs_swcre_model_vs_obs', title='('+chr(97+ii)+') '+model)
    fig.tight_layout()
    plt.legend(bbox_to_anchor=(2.0, 0.5), loc='center')
    plt.savefig('/home/users/phill/images/CIRCULATES/dynamic_cloud_feedbacks/w500_vs_swcre_model_vs_obs'+'_lon'+str(lon_min)+'to'+str(lon_max)+'_lat'+str(lat_min)+'to'+str(lat_max)+'_w500bin_width'+'{:.2f}'.format(w500_bins[1]-w500_bins[0]).replace('.', 'pt')+'_w500bin_max'+'{:.2f}'.format(w500_bins[-1]).replace('.', 'pt')+'_crebin_width'+'{:.2f}'.format(cre_bins[1]-cre_bins[0]).replace('.', 'pt')+'_crebin_max'+'{:.2f}'.format(cre_bins[-1]).replace('.', 'pt')+plot_type)
    plt.show()
#   LW CRE by model
    if plot_type == '.png':
        fig = plt.figure(0, figsize=(7,3))
    ...
    for ii in range(13):
        ...
        plot_circ_cloud_relationships(w500_bins, cre_bins, obs_data, AMIP_params_ceres_4K[model], AMIP_params_long_4K[model], labels=['Obs','AMIP 2001-2014', 'AMIP 1979-2014', ''], list_of_colors=[colorlist[3], colorlist[0], colorlist[1], colorlist[2]], era5_data=era5_data, jra55_data=jra55_data, merra2_data=merra2_data, var='lw_cre_adj2_mean', fig=fig, subplot_index=(5,3,ii+1), lon_min=lon_min, lon_max=lon_max, lat_min=lat_min, lat_max=lat_max, savename='/home/users/phill/images/CIRCULATES/dynamic_cloud_feedbacks/w500_vs_lwcre_model_vs_obs', title='('+chr(97+ii)+') '+model)
    fig.tight_layout()
    plt.legend(bbox_to_anchor=(2.0, 0.5), loc='center')
    plt.savefig('/home/users/phill/images/CIRCULATES/dynamic_cloud_feedbacks/w500_vs_lwcre_model_vs_obs'+'_lon'+str(lon_min)+'to'+str(lon_max)+'_lat'+str(lat_min)+'to'+str(lat_max)+'_w500bin_width'+'{:.2f}'.format(w500_bins[1]-w500_bins[0]).replace('.', 'pt')+'_w500bin_max'+'{:.2f}'.format(w500_bins[-1]).replace('.', 'pt')+'_crebin_width'+'{:.2f}'.format(cre_bins[1]-cre_bins[0]).replace('.', 'pt')+'_crebin_max'+'{:.2f}'.format(cre_bins[-1]).replace('.', 'pt')+plot_type)
    plt.show()
#   Plot multi-mean from different reanalyses
    ...
    plt.grid(color='lightgrey')
    fig.tight_layout()
    plt.savefig('/home/users/phill/images/CIRCULATES/dynamic_cloud_feedbacks/cre_vs_w500_err'+'_lon'+str(lon_min)+'to'+str(lon_max)+'_lat'+str(lat_min)+'to'+str(lat_max)+'_w500bin_width'+'{:.2f}'.format(w500_bins[1]-w500_bins[0]).replace('.', 'pt')+'_w500bin_max'+'{:.2f}'.format(w500_bins[-1]).replace('.', 'pt')+'_crebin_width'+'{:.2f}'.format(cre_bins[1]-cre_bins[0]).replace('.', 'pt')+'_crebin_max'+'{:.2f}'.format(cre_bins[-1]).replace('.', 'pt')+plot_type)
    plt.show()
...
def calc_feedbacks_amip(w500_bins=np.arange(-700,700.01,2), cre_bins=np.arange(-400,400.01,0.2), yearlist=range(2001,2015), n_bootstrap=2, lon_min=165, lon_max=235, lat_min=-30, lat_max=30, seed=1, spatial_av_scale=2.0, time_av_scale=24*30, rad_source='CERES_EBAF'):
    '''
    Calculates feedbacks and components of feedback
...
#   First compare data across scenarios and averaging period.
    ...
    plot_scenario_comparison(['Multi-model mean',]+complete_model_list, [AMIP_params_long_temp, AMIP4K_params_temp], obs_data['Ann'], var='circ_intensity', model_labels_list=['AMIP 1979-2014', 'AMIP4K'], lon_min=lon_min, lon_max=lon_max, lat_min=lat_min, lat_max=lat_max, errorbar=False)
    plot_scenario_comparison(complete_model_list, [AMIP_params_ceres_era, AMIP_params_long, AMIP4K_params], obs_data['Ann'], var='circ_intensity', model_labels_list=['AMIP 2001-2014', 'AMIP 1979-2014', 'AMIP+4K'], lon_min=lon_min, lon_max=lon_max, lat_min=lat_min, lat_max=lat_max)
    plot_scenario_comparison(complete_model_list, [AMIP_params_ceres_era, AMIP_params_long, AMIP4K_params], obs_data['Ann'], var='circ_mode', ylabel='Modal vertical velocity (hPa day$^{-1}$)', model_labels_list=['AMIP 2001-2014', 'AMIP 1979-2014', 'AMIP+4K'], lon_min=lon_min, lon_max=lon_max, lat_min=lat_min, lat_max=lat_max)
#   Now do plot for each model.
    for model in complete_model_list:
#       Plot vs observations
        fig = plt.figure(0)
...
#    Now compare feedbacks from model directly to feedbacks from fit for each model
    ...
    plot_model_feedbacks_vs_w500(complete_model_list, w500_bins_mid, AMIP4K_params, AMIP_params_long, obs_data, show_plots=False, lon_min=lon_min, lon_max=lon_max, lat_min=lat_min, lat_max=lat_max, w500_bins=w500_bins, cre_bins=cre_bins)
    plot_model_feedbacks_vs_w500_v2(complete_model_list, w500_bins_mid, AMIP4K_params, AMIP_params_long, obs_data, show_plots=False, lon_min=lon_min, lon_max=lon_max, lat_min=lat_min, lat_max=lat_max, w500_bins=w500_bins, cre_bins=cre_bins)
    plot_model_feedbacks_vs_w500_v3(complete_model_list, w500_bins_mid, AMIP4K_params, AMIP_params_long, obs_data, show_plots=False, lon_min=lon_min, lon_max=lon_max, lat_min=lat_min, lat_max=lat_max, w500_bins=w500_bins, cre_bins=cre_bins)
    return complete_model_list, sw_cre_dynamic_feedback, sw_cre_dynamic_obs_feedback, sw_cre_thermodynamic_feedback, sw_cre_thermodynamic_obs_feedback, sw_cre_co_variation_feedback, sw_cre_co_variation_obs_feedback, lw_cre_dynamic_feedback, lw_cre_dynamic_obs_feedback, lw_cre_thermodynamic_feedback, lw_cre_thermodynamic_obs_feedback, lw_cre_co_variation_feedback, lw_cre_co_variation_obs_feedback, net_cre_dynamic_feedback, net_cre_dynamic_obs_feedback, net_cre_thermodynamic_feedback, net_cre_thermodynamic_obs_feedback, net_cre_co_variation_feedback, net_cre_co_variation_obs_feedback, obs_data, AMIP_params_long, AMIP4K_params, net_cre_dynamic_era5_feedback, net_cre_thermodynamic_era5_feedback, net_cre_co_variation_era5_feedback,sw_cre_dynamic_era5_feedback, sw_cre_thermodynamic_era5_feedback, sw_cre_co_variation_era5_feedback, lw_cre_dynamic_era5_feedback, lw_cre_thermodynamic_era5_feedback, lw_cre_co_variation_era5_feedback, net_cre_dynamic_merra2_feedback, net_cre_thermodynamic_merra2_feedback, net_cre_co_variation_merra2_feedback,sw_cre_dynamic_merra2_feedback, sw_cre_thermodynamic_merra2_feedback, sw_cre_co_variation_merra2_feedback, lw_cre_dynamic_merra2_feedback, lw_cre_thermodynamic_merra2_feedback, lw_cre_co_variation_merra2_feedback, net_cre_dynamic_jra55_feedback, net_cre_thermodynamic_jra55_feedback, net_cre_co_variation_jra55_feedback,sw_cre_dynamic_jra55_feedback, sw_cre_thermodynamic_jra55_feedback, sw_cre_co_variation_jra55_feedback, lw_cre_dynamic_jra55_feedback, lw_cre_thermodynamic_jra55_feedback, lw_cre_co_variation_jra55_feedback, ecs_old, ecs_new, ecs_new_upper, ecs_new_lower
...
def plot_model_feedbacks_vs_w500(complete_model_list, w500_bins_mid, AMIP4K_params, AMIP_params_long, obs_data, show_plots=True, lon_min=165, lon_max=235, lat_min=-30, lat_max=30, method='AMIP', w500_bins=np.arange(-700,700.01,2), cre_bins=np.arange(-400,400.01,0.2)):
    '''
...
#   Add multi-model means to complete_model_list
    ...
    for kk,model in enumerate(complete_model_list):
        ...
        for ii, (region, cre_mean) in enumerate(zip(['SW', 'LW'], ['sw_cre_mean', 'lw_cre_mean'])):
            ...
            plt.grid(color='lightgrey')
        fig.tight_layout()
        plt.savefig('/home/users/phill/images/CIRCULATES/dynamic_cloud_feedbacks/'+method+'_'+model+'_dist_cre_vs_w500_lon'+str(lon_min)+'to'+str(lon_max)+'_lat'+str(lat_min)+'to'+str(lat_max)+plot_type)
...
def plot_model_feedbacks_vs_w500_v2(complete_model_list, w500_bins_mid, AMIP4K_params, AMIP_params_long, obs_data, show_plots=True, lon_min=165, lon_max=235, lat_min=-30, lat_max=30, method='AMIP', w500_bins=np.arange(-700,700.01,2), cre_bins=np.arange(-400,400.01,0.2)):
    '''
    Plot thermodynamic and dynamic feedbacks vs w500 for each model.
    '''
...
def plot_model_feedbacks_vs_w500_v3(complete_model_list, w500_bins_mid, AMIP4K_params, AMIP_params_long, obs_data, show_plots=True, lon_min=165, lon_max=235, lat_min=-30, lat_max=30, method='AMIP', w500_bins=np.arange(-700,700.01,2), cre_bins=np.arange(-400,400.01,0.2)):
    '''
    Plot thermodynamic and dynamic feedbacks vs w500 for each model.
    '''
...
def plot_decomposition_comparison(complete_model_list, sw_cre_dynamic, sw_cre_dynamic_param, sw_cre_thermodynamic, sw_cre_thermodynamic_param, sw_cre_co_variation, sw_cre_co_variation_param, ylabel='SW cloud feedback (W m$^{-2}$)', savename='', leg=['dynamic', 'dynamic param', 'thermodynamic', 'thermodynamic param', 'co-variation', 'co-variation param', 'sum', 'sum param'], co_variation2=True, lon_min=165, lon_max=235, lat_min=-30, lat_max=30, w500_bins=np.arange(-700,700.01,2), cre_bins=np.arange(-400,400.01,0.2), sw_cre_dynamic_err={}, sw_cre_dynamic_param_err={}, sw_cre_thermodynamic_err={}, sw_cre_thermodynamic_param_err={}, sw_cre_co_variation_err={}, sw_cre_co_variation_param_err={}, sw_cre_sum_err={}, sw_cre_sum_param_err={}, fig=None, subplot_index=111, text=None):
    ...
    fig.tight_layout()
    plt.savefig('/home/users/phill/images/CIRCULATES/dynamic_cloud_feedbacks/'+savename+'_lon'+str(lon_min)+'to'+str(lon_max)+'_lat'+str(lat_min)+'to'+str(lat_max)+'_'+'w500bin_width'+'{:.2f}'.format(w500_bins[1]-w500_bins[0]).replace('.', 'pt')+'_w500bin_max'+'{:.2f}'.format(w500_bins[-1]).replace('.', 'pt')+'crebin_width'+'{:.2f}'.format(cre_bins[1]-cre_bins[0]).replace('.', 'pt')+'_crebin_max'+'{:.2f}'.format(cre_bins[-1]).replace('.', 'pt')+plot_type)
    plt.show()    
...
def plot_scenario_comparison(complete_model_list, model_params_list, obs_data_param, var='circ_intensity', fig=None, subplot=111, ylabel='Circulation Intensity (h Pa day$^{-1}$)', region='SW', param='A', model_labels_list=['AMIP 2001-2014', 'AMIP 1979-2014', 'piControl', 'abrupt-4xCO2'], lon_min=165, lon_max=235, lat_min=-30, lat_max=30, w500_bins=np.arange(-700,700.01,2), cre_bins=np.arange(-400,400.01,0.2), errorbar=True):
    ...
    if errorbar:
        ...
        print('obs_data_param.keys()=', obs_data_param.keys())
    ...
    plt.ylabel(ylabel)
    fig.tight_layout()
    plt.savefig('/home/users/phill/images/CIRCULATES/dynamic_cloud_feedbacks/scenario_model_comparison'+'_lon'+str(lon_min)+'to'+str(lon_max)+'_lat'+str(lat_min)+'to'+str(lat_max)+'_'+''.join(model_labels_list).replace(' ','_')+'_'+ylabel.replace(' (h Pa day$^{-1}$)', '').replace(' ', '_').replace(',','')+'_w500bin_width'+'{:.2f}'.format(w500_bins[1]-w500_bins[0]).replace('.', 'pt')+'_w500bin_max'+'{:.2f}'.format(w500_bins[-1]).replace('.', 'pt')+'crebin_width'+'{:.2f}'.format(cre_bins[1]-cre_bins[0]).replace('.', 'pt')+'_crebin_max'+'{:.2f}'.format(cre_bins[-1]).replace('.', 'pt')+plot_type)
    plt.show()
